...
namespace _2ndWebApp.Migrations
{
    ...
    [Migration("20220502192630_ModelValidation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_2ndWebApp.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("_2ndWebApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("_2ndWebApp.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("_2ndWebApp.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_2ndWebApp.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("_2ndWebApp.Models.OrderDetail", b =>
                {
                    b.HasOne("_2ndWebApp.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_2ndWebApp.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("_2ndWebApp.Models.Pie", b =>
                {
                    b.HasOne("_2ndWebApp.Models.Category", "Category")
                        .WithMany("Pies")
